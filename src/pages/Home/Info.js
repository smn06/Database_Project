...
const Info = () => {
    return (
        <div className='grid xl:grid-cols-3 md:grid-cols-1 gap-5 px-14'>
            <InfoCard cardTitle="Opening Hour" bgClass="bg-gradient-to-r from-secondary to-primary" img={clock}></InfoCard>
